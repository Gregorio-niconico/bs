package com.example.walkwalk.step.service;
...
import com.example.walkwalk.MainActivity;
import com.example.walkwalk.step.UpdateUiCallBack;
import com.example.walkwalk.step.accelerometer.StepCount;
import com.example.walkwalk.step.accelerometer.StepValuePassListener;
...
//        initTodayData();
    ...
    private void initNotification() {
        ...
        mBuilder.setContentTitle(getResources().getString(R.string.app_name))
                .setContentText("今日步数" + CURRENT_STEP )
...
//            initTodayData();
     ...
     */
    private void isCall() {
        String time = this.getSharedPreferences("share_date", Context.MODE_MULTI_PROCESS).getString("achieveTime", "18:00");
        String plan = this.getSharedPreferences("share_date", Context.MODE_MULTI_PROCESS).getString("planWalk_QTY", "3000");
