package com.example.walkwalk.view;
...
import com.example.walkwalk.utils.GetDpSpUtils;
import com.example.walkwalk.utils.LogUtils;
...
public class HistoryChartView extends View {
    ...
    private int mMode = 2;// 从Activity传过来的模式值 1：天 2：周 3：月 4：年
    ...
    private String[] Ylabel = { "0", "800", "1600", "2400", "3200" };
    private String[] Ylabel2 = { "0", "40", "80", "120", "160" };
